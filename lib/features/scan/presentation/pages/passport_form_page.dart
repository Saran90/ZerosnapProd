...
class _PassportFormPageState extends State<PassportFormPage> {
  ...
  void dispose() {
    for (final c in [
      ...
      _durationOfStayCtrl,
      _checkoutDateCtrl,
      _nextDestinationCtrl,
      _visaDocNoCtrl,
      _visaIssuingCountryCtrl,
      _visaPOICityCtrl,
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                _pickVisaImage(ImageSource.camera);
              },
            ),
            ListTile(
              leading: const Icon(
              ...
              onTap: () {
                Navigator.pop(context);
                _pickVisaImage(ImageSource.gallery);
              },
            ),
            const SizedBox(height: 8),
          ],
  ...
  Widget _buildVisaSection() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        // Scan visa via MRZ scanner
        SizedBox(
          width: double.infinity,
          child: OutlinedButton.icon(
            onPressed: _scanVisa,
            icon: const Icon(Icons.document_scanner_outlined),
            label: const Text('Scan Visa (MRZ)'),
        ...
        _FormField(
          ...
          controller: _visaIssuingCountryCtrl,
        ),
        _FormField(
          label: 'Visa Place of Issue (City)',
